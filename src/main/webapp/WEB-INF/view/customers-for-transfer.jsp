	...
	<div id="container">
		<div id="content">
			...
			<p style="font-size: 35px">
				<a href="${pageContext.request.contextPath}/showAllCustomers"><i
					class="fa fa-arrow-circle-left" aria-hidden="true"></i> </i><span>Back</a></span></a>


				<a href="${pageContext.request.contextPath}/"
					style="padding-left: 35px"><i class="fa fa-home"></i> </i><span>Home</a></span></a>
			</p>
			<br>
			...
			<table class="table table-striped custom-table">
				...
				<c:forEach var="tempCustomer" items="${customers}">
					...
					<c:url var="paymentLink" value="/paymentPage">
						<c:param name="customerId" value="${tempCustomer.id}" />
						<c:param name="currentCustomerId" value="${currentCustomer.id}" />
					</c:url>
					...
					<tr scope="row">
						...
						<td><a href="${paymentLink}">Transfer</i></a></td>
